...
DEMO_SEQUENCE = [
    ...
    ("type", '10 PRINT CHR$(27);"T ORICUTRON MCP DEMO"\\r', 4, "Line 10"),
    ("type", "20 PRINT\\r", 3, "Line 20"),
    ("type", "30 FOR I=1 TO 7\\r", 3, "Line 30"),
    ("type", "40 INK I\\r", 3, "Line 40"),
    ("type", '50 PRINT " CLAUDE IS TYPING THIS!"\\r', 4, "Line 50"),
    ("type", "60 NEXT I\\r", 3, "Line 60"),
    ("type", "70 INK 3\\r", 3, "Line 70"),
    ("type", "80 PRINT\\r", 3, "Line 80"),
    ("type", '90 PRINT " CONTROLLED VIA UNIX SOCKET"\\r', 4, "Line 90"),
